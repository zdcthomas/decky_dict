...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2bd47cee569ae4c6: (
    a: number,
    b: number,
    c: number
  ) => void;
  ...
  readonly wasm_bindgen__convert__closures__invoke2_mut__hfe1195d34914cc54: (
    a: number,
    b: number,
    c: number,
    d: number
